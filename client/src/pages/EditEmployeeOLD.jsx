...
const EditEmployee = () => {
const [employee, setEmployee] = useState({firstName: '',  lastName: '',  startWorkYear: todayISO() , departmentId:''});
...
return (
  ...
  <Stack spacing={2}>
    ...
    <TextField
     ...
     //toDateInputValue displays the date in correct format, in case there is no value in startWorkYear then the current day will be displyed
        value= {toDateInputValue(employee.startWorkYear) || todayISO()}
   ...
   {/* </TextField> */}
      ...
      <Grid container justifyContent="center" alignItems="center" spacing={2} sx={{ mt: 2 }}>
        <Grid item>
          ...
          <Button  sx={{ width: '100px'}} variant="contained" onClick= {() => {updateEmployee(), actionsAllowedClientUtils(user)}}>Update</Button>
        </Grid>
        <Grid item>
